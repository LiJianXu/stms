...
-->
	...
	<table id="tt" class="easyui-datagrid" title="学生痕迹管理系统>早操情况" style="width:1040px;height:auto;"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'attr1',width:230,align:'center'">抄近道/缺席</th>
				...
				<tr>
					...
					<th data-options="field:'attr1',width:230,align:'center'">100分</th>
					<th data-options="field:'status',width:150,align:'center'">6666666</th>
				</tr>
