...
-->
	...
	<table id="tt" class="easyui-datagrid" title="学生痕迹管理系统>早操情况" style="width:auto;height:auto;"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'attr1',width:120,align:'center'">抄近道/缺席</th>
					<th data-options="field:'status',width:100,align:'center'">备注</th>
					<th data-options="field:'status',width:120,align:'center'">审批结果</th>
					<th data-options="field:'status',width:400,align:'center'">审批</th>
				</tr>
				<tr>
					<th data-options="field:'id',width:50,align:'center'">001</th>
					<th data-options="field:'gou',width:50,align:'center'"><input type="checkbox"></th>
					<th data-options="field:'stuid',width:100,align:'center'">20150424</th>
					<th data-options="field:'name',width:80,align:'center'">罗旭杨</th>
					<th data-options="field:'date',width:100,align:'center'">2015.10.20</th>
					<th data-options="field:'attr1',width:120,align:'center'">100分</th>
					<th data-options="field:'status',width:100,align:'center'">6666666</th>
					<th data-options="field:'status',width:120,align:'center'">通过</th>
					<th data-options="field:'status',width:300,align:'center'">
						<input type="submit" value="通过" style="background:green;color:#FFFFFF"><spen>&nbsp;<input type="submit" value="不通过" style="background:#FF9900;color:#FFFFFF">
					</th>				
				</tr>
