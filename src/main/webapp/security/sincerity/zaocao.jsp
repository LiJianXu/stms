...
<body>
	...
	<table id="dataGrid" class="easyui-datagrid" title="学生痕迹管理系统>出勤情况"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'remarks',width:350,align:'center'">详情</th>
						...
						<tr style="background-color: #fff;">
							...
							<td><select id="ruleId" class="easyui-combobox"
								style="width: 200px; height: 32px;">
									<option value="15">迟到</option>
									<option value="16">早退</option>
									<option value="17">旷跑</option>
							</select></td>
						</tr>
						<tr>
							<td>详情：</td>
	...
	<script type="text/javascript">
		...
		function getData(classId, page, size) {
			class_Id = classId;
			$.get("/stms/honest/findExercises?menuId=3&studentClassId=" + classId + "&pageNum="
