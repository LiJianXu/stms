...
<body>
	...
	<table id="dataGrid" class="easyui-datagrid" title="学生痕迹管理系统>集体情况"
						...
						<tr style="background-color: #fff;">
							...
							<td><select id="ruleId" class="easyui-combobox"
								style="width: 200px; height: 32px;">
									<option value="12">未参加活动</option>
									<option value="13">破坏集体活动</option>
									<option value="14">代签</option>
							</select></td>
						</tr>
						<tr>
							<td>详情：</td>
	...
	<script type="text/javascript">
		...
		function getData(classId, page, size) {
			class_Id = classId;
			$.get("/stms/get_executes?menuId=9&classId=" + classId + "&page="
