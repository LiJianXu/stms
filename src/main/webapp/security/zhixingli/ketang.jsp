...
<body>
	...
	<table id="dataGrid" class="easyui-datagrid" title="学生痕迹管理系统>课堂纪律"
						...
						<tr style="background-color: #fff;">
							...
							<td><select id="ruleId" class="easyui-combobox"
								style="width: 200px; height: 32px;">
									<option value="9">上课讲话</option>
									<option value="10">未交作业</option>
									<option value="11">扰乱课堂纪律</option>
							</select></td>
						</tr>
						<tr>
							<td>详情：</td>
	...
	<script type="text/javascript">
		...
		function getData(classId, page, size) {
			class_Id = classId;
			$.get("/stms/get_executes?menuId=8&classId=" + classId + "&page="
