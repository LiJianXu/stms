...
<body>
	...
	<table id="dataGrid" class="easyui-datagrid" title="学生痕迹管理系统>寝室情况"
						...
						<tr style="background-color: #fff;">
							...
							<td><select id="ruleId" class="easyui-combobox"
								style="width: 200px; height: 32px;">
									<option value="5">未打扫寝室</option>
									<option value="6">未关水电</option>
									<option value="7">迟到晚归</option>
									<option value="8">夜不归寝</option>
							</select></td>
						</tr>
						<tr>
							<td>详情：</td>
	...
	<script type="text/javascript">
		...
		function getData(classId, page, size) {
			class_Id = classId;
			$.get("/stms/get_executes?menuId=11&classId=" + classId + "&page="
