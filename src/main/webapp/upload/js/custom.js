$(document).ready(function(){
    ...
    $('#demo-fileInput-4').filer({
        changeInput: '<div class="jFiler-input-dragDrop"><div class="jFiler-input-inner"><div class="jFiler-input-icon"><i class="icon-jfi-folder"></i></div><div class="jFiler-input-text"><h3>点击图片选择要上传的文件</h3></div></div>',
        showThumbs: true,
        theme: "dragdropbox",
